...
const u16 gEasyChatWordsByLetter_L[] = {
    ...
    EC_POKEMON(LUXRAY),
    EC_POKEMON(LUVDISC),
    EC_POKEMON(LYCANROCDUSK),
    EC_POKEMON(LYCANROCMIDDAY),
    EC_POKEMON(LYCANROCMIDNIGHT),
};
