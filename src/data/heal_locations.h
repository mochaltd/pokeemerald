static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ELDEROOT_TOWN - 1] = {MAP_GROUP(ELDEROOT_TOWN), MAP_NUM(ELDEROOT_TOWN), 5, 9},
    ...
    [HEAL_LOCATION_SHIVERVALE_TOWN - 1] = {MAP_GROUP(SHIVERVALE_TOWN), MAP_NUM(SHIVERVALE_TOWN), 19, 17},
    [HEAL_LOCATION_ROYALSPUR_CITY - 1] = {MAP_GROUP(ROYALSPUR_CITY), MAP_NUM(ROYALSPUR_CITY), 10, 21},
    [HEAL_LOCATION_BRAVEFORT_TOWN - 1] = {MAP_GROUP(BRAVEFORT_TOWN), MAP_NUM(BRAVEFORT_TOWN), 13, 17},
};
