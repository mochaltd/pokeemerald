const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR}},
                           {{EVO_ITEM, ITEM_METEORITE, SPECIES_KLEAVOR}},
    ...
    [SPECIES_HOUNDOUR]   = {{EVO_LEVEL, 38, SPECIES_HOUNDOOM}},
    ...
    [SPECIES_MAKUHITA]   = {{EVO_LEVEL, 25, SPECIES_HARIYAMA}},
    ...
    [SPECIES_ROCKRUFF]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LYCANROCMIDDAY},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_LYCANROCMIDNIGHT},
                            {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_LYCANROCDUSK}},
    ...
    [SPECIES_LITWICK]    = {{EVO_LEVEL, 28, SPECIES_LAMPENT}},
    ...
    [SPECIES_WOOBAT]     = {{EVO_LEVEL, 28, SPECIES_SWOOBAT}},
    ...
    [SPECIES_TOXEL]      = {{EVO_LEVEL, 25, SPECIES_TOXTRICITY}},
    [SPECIES_FERROSEED]  = {{EVO_LEVEL, 31, SPECIES_FERROTHORN}},
    [SPECIES_JOLTIK]     = {{EVO_LEVEL, 32, SPECIES_GALVANTULA}},
    [SPECIES_SHINX]      = {{EVO_LEVEL, 25, SPECIES_LUXIO}},
    ...
    [SPECIES_SNEASEL]    = {{EVO_LEVEL, 35, SPECIES_WEAVILE}},
    [SPECIES_SNOVER]     = {{EVO_LEVEL, 40, SPECIES_ABOMASNOW}},
    [SPECIES_CRABRAWLER] = {{EVO_LEVEL, 36, SPECIES_ABOMICRAB}},
