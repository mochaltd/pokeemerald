const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_LYCANROCMIDDAY] = sLycanrocMiddayLevelUpLearnset,
    [SPECIES_LYCANROCMIDNIGHT] = sLycanrocMidnightLevelUpLearnset,
    [SPECIES_LYCANROCDUSK] = sLycanrocDuskLevelUpLearnset,
    ...
    [SPECIES_ABOMICRAB] = sAbomicrabLevelUpLearnset,
