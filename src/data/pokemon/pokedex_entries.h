const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_ABOMICRAB] =
    {
        .categoryName = _("Wool Crab"),
        .height = 17,
        .weight = 1800,
        .description = gAbomicrabPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
