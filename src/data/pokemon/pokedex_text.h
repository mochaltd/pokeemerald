...
const u8 gCorviknightPokedexText[] = _(
    ...
    "of the Shizen region. The black luster of\n"
...
const u8 gCarkolPokedexText[] = _(
    ...
    "the lives of people in the Shizen region.");
...
const u8 gAbomicrabPokedexText[] = _(
