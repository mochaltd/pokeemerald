const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(LYCANROCMIDDAY, gMonBackPic_LycanrocMidday),
    SPECIES_SPRITE(LYCANROCMIDNIGHT, gMonBackPic_LycanrocMidnight),
    SPECIES_SPRITE(LYCANROCDUSK, gMonBackPic_LycanrocDusk),
    ...
    SPECIES_SPRITE(ABOMICRAB, gMonBackPic_Abomicrab),
