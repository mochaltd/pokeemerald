const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_LYCANROCMIDDAY] = gMonFootprint_LycanrocMidday,
    [SPECIES_LYCANROCMIDNIGHT] = gMonFootprint_LycanrocMidnight,
    [SPECIES_LYCANROCDUSK] = gMonFootprint_LycanrocDusk,
    ...
    [SPECIES_ABOMICRAB] = gMonFootprint_Abomicrab,
