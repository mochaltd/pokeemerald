...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_RATTATA]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 11 },
    [SPECIES_RATICATE]    = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    ...
    [SPECIES_SANDSHREW]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 13 },
    [SPECIES_SANDSLASH]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_GEODUDE]     = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 17 },
    [SPECIES_GRAVELER]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_GOLEM]       = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  1 },
    ...
    [SPECIES_GRIMER]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_MUK]         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_TYPHLOSION]  = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    ...
    [SPECIES_ZIGZAGOON]   = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 13 },
    ...
    [SPECIES_LYCANROCMIDDAY]    = { .size = MON_COORDS_SIZE(57, 53), .y_offset = 5 },
    [SPECIES_LYCANROCMIDNIGHT]    = { .size = MON_COORDS_SIZE(56, 61), .y_offset = 0 },
    [SPECIES_LYCANROCDUSK]    = { .size = MON_COORDS_SIZE(57, 58), .y_offset = 6 },
    ...
    [SPECIES_ZORUA]       = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  1 },
    [SPECIES_ZOROARK]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_TOXTRICITY]  = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  2 },
    ...
    [SPECIES_ABOMICRAB]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_HAWLUCHA]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_DIALGA]      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
