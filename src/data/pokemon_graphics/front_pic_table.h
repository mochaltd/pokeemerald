const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(LYCANROCMIDDAY, gMonFrontPic_LycanrocMidday),
    SPECIES_SPRITE(LYCANROCMIDNIGHT, gMonFrontPic_LycanrocMidnight),
    SPECIES_SPRITE(LYCANROCDUSK, gMonFrontPic_LycanrocDusk),
    ...
    SPECIES_SPRITE(ABOMICRAB, gMonFrontPic_Abomicrab),
