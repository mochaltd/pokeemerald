const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(LYCANROCMIDDAY, gMonPalette_LycanrocMidday),
    SPECIES_PAL(LYCANROCMIDNIGHT, gMonPalette_LycanrocMidnight),
    SPECIES_PAL(LYCANROCDUSK, gMonPalette_LycanrocDusk),
    ...
    SPECIES_PAL(ABOMICRAB, gMonPalette_Abomicrab),
