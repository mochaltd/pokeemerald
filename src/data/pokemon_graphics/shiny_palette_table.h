const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(LYCANROCMIDDAY, gMonShinyPalette_LycanrocMidday),
    SPECIES_SHINY_PAL(LYCANROCMIDNIGHT, gMonShinyPalette_LycanrocMidnight),
    SPECIES_SHINY_PAL(LYCANROCDUSK, gMonShinyPalette_LycanrocDusk),
    ...
    SPECIES_SHINY_PAL(ABOMICRAB, gMonShinyPalette_Abomicrab),
