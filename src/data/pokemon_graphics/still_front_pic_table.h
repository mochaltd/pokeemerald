...
// Gen III
    ...
    SPECIES_SPRITE(ROOKIDEE,      gMonStillFrontPic_Rookidee),
    SPECIES_SPRITE(CORVISQUIRE,   gMonStillFrontPic_Corvisquire),
    SPECIES_SPRITE(CORVIKNIGHT,   gMonStillFrontPic_Corviknight),
    ...
    SPECIES_SPRITE(LYCANROCMIDDAY,      gMonStillFrontPic_LycanrocMidday),
    SPECIES_SPRITE(LYCANROCMIDNIGHT,      gMonStillFrontPic_LycanrocMidnight),
    SPECIES_SPRITE(LYCANROCDUSK,      gMonStillFrontPic_LycanrocDusk),
    ...
    SPECIES_SPRITE(WOOBAT,        gMonStillFrontPic_Woobat),
    SPECIES_SPRITE(SWOOBAT,       gMonStillFrontPic_Swoobat),
    SPECIES_SPRITE(CLAUNCHER,     gMonStillFrontPic_Clauncher),
    SPECIES_SPRITE(CLAWITZER,     gMonStillFrontPic_Clawitzer),
    SPECIES_SPRITE(KLAWF,         gMonStillFrontPic_Klawf),
    SPECIES_SPRITE(TYMPOLE,       gMonStillFrontPic_Tympole),
    SPECIES_SPRITE(PALPITOAD,     gMonStillFrontPic_Palpitoad),
    ...
    SPECIES_SPRITE(ROLYCOLY,      gMonStillFrontPic_Rolycoly),
    ...
    SPECIES_SPRITE(CRABRAWLER,    gMonStillFrontPic_Crabrawler),
    SPECIES_SPRITE(ABOMICRAB,     gMonStillFrontPic_Abomicrab),
    ...
    SPECIES_SPRITE(HAWLUCHA,      gMonStillFrontPic_Hawlucha),
