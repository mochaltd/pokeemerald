...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_SANDSHREW]  = BACK_ANIM_NONE,
    [SPECIES_SANDSLASH]  = BACK_ANIM_NONE,
    ...
    [SPECIES_GROWLITHE]  = BACK_ANIM_NONE,
    [SPECIES_ARCANINE]   = BACK_ANIM_NONE,
    ...
    [SPECIES_GEODUDE]    = BACK_ANIM_NONE,
    ...
    [SPECIES_GRIMER]     = BACK_ANIM_NONE,
    [SPECIES_MUK]        = BACK_ANIM_NONE,
    ...
    [SPECIES_VOLTORB]    = BACK_ANIM_NONE,
    [SPECIES_ELECTRODE]  = BACK_ANIM_NONE,
    ...
    [SPECIES_WEEZING]    = BACK_ANIM_NONE,
    ...
    [SPECIES_LYCANROCMIDDAY]   = BACK_ANIM_V_SHAKE,
    [SPECIES_LYCANROCMIDNIGHT]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_LYCANROCDUSK]   = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_ABOMICRAB]  = BACK_ANIM_NONE,
