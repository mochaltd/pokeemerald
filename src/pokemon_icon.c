...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_LYCANROCMIDDAY] = gMonIcon_LycanrocMidday,
    [SPECIES_LYCANROCMIDNIGHT] = gMonIcon_LycanrocMidnight,
    [SPECIES_LYCANROCDUSK] = gMonIcon_LycanrocDusk,
    ...
    [SPECIES_ABOMICRAB] = gMonIcon_Abomicrab,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_SCOLIPEDE] = 2,
    [SPECIES_ROCKRUFF] = 2,
    [SPECIES_LYCANROCMIDDAY] = 2,
    [SPECIES_LYCANROCMIDNIGHT] = 0,
    [SPECIES_LYCANROCDUSK] = 0,
    [SPECIES_SALANDIT] = 2,
    [SPECIES_SALAZZLE] = 0,
    [SPECIES_CROAGUNK] = 0,
    [SPECIES_TOXICROAK] = 0,
