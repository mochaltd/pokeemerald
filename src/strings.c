...
const u8 gText_DexHoennDescription[] = _("Shizen region's Pokédex");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Shizen region.");
...
const u8 gText_ContinueMenuBadges[] = _("STONES");
...
const u8 gText_SavingBadges[] = _("STONES");
